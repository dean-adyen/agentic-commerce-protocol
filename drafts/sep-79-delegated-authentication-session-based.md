...
The `channel` object can be provided here or deferred to the `/{id}/authenticate` call. Providing it here allows early validation; deferring allows parallel collection during fingerprinting.
